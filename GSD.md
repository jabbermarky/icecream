...
| `binder-audit-verification.md` | Which of its claims were checked against the code, and what that found. |
| `ingredient-onboarding-design.md` | The second stream. |
| `sprinkles-stack-decisions.md` | Stack decisions for the Sprinkles port. |
| `RESEARCH-LLM-INTEGRATION.md` · `STRICT-MODE-AUDIT.md` | Research and audit notes. |
